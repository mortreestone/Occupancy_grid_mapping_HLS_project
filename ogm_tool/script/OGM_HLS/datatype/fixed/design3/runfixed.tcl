...
# add source files 
add_files datatype/fixed/design3/header.h -cflags $CFLAGS
add_files datatype/fixed/design3/ogm.cpp -cflags $CFLAGS

# add testbench files
add_files -tb datatype/fixed/design3/data.h -cflags $CFLAGS
add_files -tb datatype/fixed/design3/grid1.h -cflags $CFLAGS
add_files -tb datatype/fixed/design3/main.cpp -cflags $CFLAGS

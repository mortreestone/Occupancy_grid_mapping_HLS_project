...
# add source files 
add_files datatype/fixed/design1/header.h -cflags $CFLAGS
add_files datatype/fixed/design1/ogm.cpp -cflags $CFLAGS

# add testbench files
add_files -tb datatype/fixed/design1/data.h -cflags $CFLAGS
add_files -tb datatype/fixed/design1/grid1.h -cflags $CFLAGS
add_files -tb datatype/fixed/design1/main.cpp -cflags $CFLAGS

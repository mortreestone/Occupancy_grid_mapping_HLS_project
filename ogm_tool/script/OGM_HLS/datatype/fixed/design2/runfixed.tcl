...
# add source files 
add_files datatype/fixed/design2/header.h -cflags $CFLAGS
add_files datatype/fixed/design2/ogm.cpp -cflags $CFLAGS

# add testbench files
add_files -tb datatype/fixed/design2/data.h -cflags $CFLAGS
add_files -tb datatype/fixed/design2/grid1.h -cflags $CFLAGS
add_files -tb datatype/fixed/design2/main.cpp -cflags $CFLAGS

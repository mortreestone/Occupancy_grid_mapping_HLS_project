...
add_files datatype/float/header.h
add_files datatype/float/ogm.cpp

# add testbench files
#add_files -tb ../datatype/float/data.h -cflags $CFLAGS
#add_files -tb ../datatype/float/grid1.h -cflags $CFLAGS
#add_files -tb ../datatype/float/main.cpp -cflags $CFLAGS
add_files -tb datatype/float/data.h 
add_files -tb datatype/float/grid1.h 
add_files -tb datatype/float/main.cpp
...
#export_design -rtl verilog -format ip_catalog -output /home/szuwei/Desktop/HLS/HLS_OGM/output/${hls_prj}.zip
export_design -flow syn -rtl verilog -format ip_catalog -output /home/szuwei/Desktop/HLS/HLS_OGM/output/${hls_prj}.zip

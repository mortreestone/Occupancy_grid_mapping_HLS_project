...
set CFLAGS "-DPRESOLUTION=${R} -DPA=${A} -DPYDIM=${Y} -DPXDIM=${X}" 
...
# add source files 
add_files resolution_A/header.h -cflags $CFLAGS
add_files resolution_A/ogm.cpp -cflags $CFLAGS

# add testbench files
add_files -tb resolution_A/data.h -cflags $CFLAGS
add_files -tb resolution_A/grid_1.h -cflags $CFLAGS
add_files -tb resolution_A/main.cpp -cflags $CFLAGS
